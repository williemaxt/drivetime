...
if(isset($_POST['forgotSubmit'])){
    ...
    if(!empty($_POST['email'])){
        ...
        if($prevUser > 0){
            ...
            if($update){
                $resetPassLink = 'https://drivetimepro1.000webhostapp.com/resetPassword.php?fp_code='.$uniqidStr;
                //Above line will need editing. 'localhost:8888' must be removed and exchanged for your domain.
                //Keep the /resetPassword.php?fp_code... This is very important.
                //Example: https://www.prodrivetime.com/resetPassword.php?fp_code='.$uniqidStr;
