...
<div class="wrapper">
    ...
    if(isset($_POST['submitDriverUpdate'])) {
        ...
        $state = $_POST['state'];
        $conn->query("UPDATE `drivers` SET name = '$name', city = '$city', experience = '$experience', state = '$state' WHERE email = '$username';");
        header('Location: '.$_SERVER['REQUEST_URI']);
    } else {
    ...
    <main>
        ...
        if (isset($_POST['accept'])) {
            ...
            $con->query("DELETE FROM request_trans WHERE id=$id");
